/**
 * @file
 * @brief Implementation of Country class.
 */
...
constexpr KString Country::COUNTRY_TABLE[][2] = {
	[ZZ] = { "?", "Unknown" },
	[AD] = { "AD", "Andorra" },
...
constexpr unsigned int Country::COUNTRY_TABLE_SIZE = sizeof COUNTRY_TABLE / sizeof COUNTRY_TABLE[0];
